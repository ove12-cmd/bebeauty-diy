const ROWS = [
  {
    ...
    label: "Price", diy: "35€", salon: "80–150€",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    ...
    label: "Time", diy: "10 minutes", salon: "1 hour",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    ...
    label: "Booking required", diy: "Not needed", salon: "Required",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    ...
    label: "Location", diy: "At home", salon: "Varies by salon",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    ...
    label: "Crystals", diy: "Swarovski", salon: "Varies",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    ...
    label: "Lasts", diy: "2–4 weeks", salon: "2–4 weeks",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    ...
    label: "Dentist visit", diy: "Not needed", salon: "Sometimes recommended",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    ...
    label: "Kit", diy: "Enough for multiple applications", salon: "One-time service",
  },
];
  ...
  return (
    <section className="bb-why">
      <div className="bb-why__left">
        <p className="bb-why__label">Why choose beBeauty DIY</p>
        <h2 className="bb-why__title">Salon results.<br />No salon required.</h2>
      </div>
      ...
      <div className="bb-why__table">
        ...
        <div className="bb-why__row bb-why__row--header">
          ...
          <span className="bb-why__col-head">Salon</span>
        </div>
