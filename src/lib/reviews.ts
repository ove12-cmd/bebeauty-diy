...
export const DEFAULT_REVIEWS: Review[] = [
  { name: "Marii", date: "juuni 2025", rating: 5, text: "kiire tarne, ilus tulemus, ei oskagi rohkem tahta", placeholder: true },
  { name: "Kertu", date: "juuli 2025", rating: 5, photos: ["/reviews/pair-1-a.webp", "/reviews/pair-1-b.webp"], text: "Väga rahul! UV Lamp töötab kiirelt ja soovitan kindlasti ka põsehoidjat kasutada, tegelikult üllatavalt vajalik asi.", placeholder: true },
  ...
  { name: "Reelika S.", date: "3 kuud tagasi", rating: 5, text: "Mul on varem salongis kristall hambale paigaldatud, aga see komplekt on mugavam. Võtsin 2.3 mm, kolmas nädal käib ja ikka läigib.", placeholder: true },
  ...
  { name: "Kristi", date: "august 2025", rating: 4, text: "Komplekt on hea, aga juhendis võiks olla rohkem pilte. Vaatasin lõpuks yt videot ja siis sai selgeks ja pandud ilusti.", reply: "Hea märkus. Täiendasime vahepeal juhendit piltidega, aitäh tagasiside eest.", placeholder: true },
  ...
  { name: "Laura", date: "september 2025", rating: 5, text: "Ma olen kohutavalt kärsitu inimene ja isegi mina sain hakkama.", placeholder: true },
  { name: "Diana", date: "september 2025", rating: 5, text: "Väga ilus efekt, eriti Boreale kristall. Vastu päikest lausa sädeleb.", placeholder: true },
  ...
  { name: "Kaisa", date: "oktoober 2025", rating: 4, text: "Tulemus hea, aga tellisin 2.3 mm ja see on minu väikese hamba jaoks natuke suur. Minu enda valikuviga.", reply: "Lisasime tootelehele suuruste võrdluse, et valik oleks lihtsam.", placeholder: true },
  { name: "Mari-Liis", date: "oktoober 2025", rating: 5, text: "Ostsin tütrele kingituseks, oli väga rõõmus", placeholder: true },
  { name: "Helena", date: "november 2025", rating: 5, text: "Hind ja kvaliteet on paigas. Tuleks veel rohkem värve.", placeholder: true },
  { name: "Sirli", date: "november 2025", rating: 5, text: "Paigaldasin köögilaua taga peegli abil, umbes 8 minutit. Ei olnud üldse keeruline.", placeholder: true },
  ...
  { name: "Marta", date: "detsember 2025", rating: 5, text: "väga rahul, kindlasrti soovitan kes tahab proovida", placeholder: true },
  { name: "Rebeka", date: "detsember 2025", rating: 5, text: "UV lamp on väike aga võimas.", placeholder: true },
  { name: "Aleksandra", date: "jaanuar 2026", rating: 5, photos: ["/reviews/pair-5-a.webp", "/reviews/pair-5-b.webp"], text: "Otlitšno! Kõik oli ka eesti keeles selge, sai kiiresti aru.", placeholder: true },
  { name: "Kelly", date: "jaanuar 2026", rating: 4, text: "Mulle meeldib, lihtsalt tahaks, et komplektis oleks rohkem kui 10 kristalli.", reply: "Aitäh, Kelly. Kristalle saab tellida ka eraldi: https://bebeauty-diy.ee/kristallid — saatsime lingi ka Teile e-postile.", placeholder: true },
  ...
  { name: "Johanna", date: "veebruar 2026", rating: 5, text: "Panin emale ka peale, tema oli algul väga skeptiline, nüüd tahab teist ka. :D", placeholder: true },
  { name: "Kadri", date: "veebruar 2026", rating: 4, text: "Kvaliteet on OK. Karbi disain võiks natuke kindlam olla, minu oma jõudis kohale pisut muljutud.", reply: "Vabandame, Kadri. Vahetasime vahepeal pakendi tugevama vastu.", placeholder: true },
  ...
  { name: "Maarja", date: "märts 2026", rating: 4, text: "Hea toode, aga minul püsis kaks nädalat, mitte neli.", reply: "Aitäh, Maarja. Kaks nädalat on täiesti normaalne, kuigi tavaliselt püsib üle 2–4 nädala.", placeholder: true },
  { name: "Kätlin", date: "märts 2026", rating: 5, photos: ["/reviews/pair-6-a.webp", "/reviews/pair-6-b.webp"], text: "Tellisin kaks komplekti, endale ja õele. Meil mõlemal õnnestus esimese korraga ja jäi väga lahe", placeholder: true },
